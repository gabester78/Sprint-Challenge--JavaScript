...
let trex = {name:'tyrannosaurus', diet: 'carnivorous', weight: '7000kg' , length: '12m', period: 'Late Cretaceous'};

// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
let stego = {name: 'stegosaurus', diet: 'herbivorous', weight: '2000kg', length: '9m', period: 'Late Jurassic'};

// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous
let raptor = {name: 'velociraptor', diet: 'carnivorous', weight: '15kg', length: '1.8m', period: 'Late Cretaceous'};
...
trex.roar = (() => {return 'RAWERSRARARWERSARARARRRR!'});
...
const unisWithUni = [];
graduates.forEach((graduate) => { if (graduate.university.includes('Uni')) unisWithUni.push(graduate.university);});
...
zooAnimals.filter((zooAnimals) => { if (zooAnimals.population < 5) lowPopulationAnimals.push(zooAnimals.population); });
...
*/
const populationTotal = zooAnimals.reduce((accumulator, currentValue) => { let cv = currentValue.population; return accumulator + cv;},0);
